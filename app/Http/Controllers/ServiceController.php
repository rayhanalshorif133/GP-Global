...
class ServiceController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $service->productId = $request->product_id;
            $service->renewal_notification_api = $request->renewal_notification_api;
            $service->notification_url = $request->notification_url;
            $service->type = $request->type;
            $service->validity = $request->validity;
            $service->redirect_url = $request->redirect_url;
            $service->portal_link = $request->portal_link;
