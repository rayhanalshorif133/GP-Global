...
class PartnerController extends Controller
{
    ...
    public function smsmessaging(Request $request, $senderNumber)
    {
        ...
        try {
            ...
            // Goldenstream service
            else if($request->serviceKeyword == 'GSD'){
                $msg = 'Goldenstream সার্ভিসটি চালু হয়েছে। চার্জ ' . $service->amount . ' Tk/1 দিন (ভ্যাট,এসসি প্রযোজ্য)। বন্ধ করতে ভিজিট করুন। ' . $urlLink;
            } 
            else{
            ...
            $partnerSmsMessaging->keyword = $request->serviceKeyword;
