    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                ...
                <li class="nav-item">
                    <a href="{{ route('log.subs-and-unsubs') }}" class="nav-link @if ($routeName == 'log.subs-and-unsubs') active @endif">
                ...
                <li class="nav-item">
                    <a href="{{ route('log.charge') }}" class="nav-link @if ($routeName == 'log.charge') active @endif">
                ...
                <li class="nav-item">
                    <a href="{{ route('log.ondemand.charge') }}" class="nav-link @if ($routeName == 'log.ondemand.charge') active @endif">
                ...
                <li class="nav-item">
                    <a href="{{ route('log.subs-based') }}" class="nav-link @if ($routeName == 'log.subs-based') active @endif">
                ...
                <li class="nav-item">
                    <a href="{{ route('service.index') }}" class="nav-link @if ($routeName == 'service.index') active @endif">
                ...
                <li class="nav-item">
                    <a href="{{ route('customer-log.index') }}" class="nav-link @if ($routeName == 'customer-log.index') active @endif">
