...
@section('breadcrumb')
    <div class="col-sm-6">
        <h1 class="m-0">On Demand Charge Log</h1>
    </div>
    <div class="col-sm-6">
    ...
    <div class="px-2">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <table class="table table-bordered" id="onDemandChargeTableID">
                    <thead>
                        <tr>
                            <th>#</th>
                            <th>Keyword</th>
            ...
            let INIT_DATATABLE = {
                ...
                footerCallback: function(row, data, start, end, display) {
                    ...
                    data.length > 0 && data.forEach((item, index) => {
                        totalSubscount += item.total_charge;
                    });
                    $('#total_charges').text(totalSubscount);
                    return 0;
                },
            };

            table = $('#onDemandChargeTableID').DataTable(INIT_DATATABLE);
